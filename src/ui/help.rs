...
pub const KEYS: &[(&str, &[(&str, &str)])] = &[
    ...
    (
        ...
        &[
            ...
            ("F", "save / unfollow the playlist you are on"),
            ("E", "edit a playlist of your own"),
            ("C", "copy the playlist you are on"),
            ("d", "delete a playlist of your own"),
            ("b / B", "open track's album / artist"),
            ("i", "read about the artist you are on"),
...
const MOUSE_HINTS: &[&str] = &[
    ...
    "on an artist page, click the line about them to read the rest",
